...
<%@page import ="in.gadgethub.dao.*,in.gadgethub.pojo.*,in.gadgethub.dao.impl.*,javax.servlet.ServletOutputStream,java.io.*,java.util.*,in.gadgethub.ulility.Appinfo"%>
<!DOCTYPE html> 
<html> 
    <head> 
                ...
                <tbody> 
                    <%
                        ...
                        for (CartPojo item : cartItems) {
                            ...
                            int prodQuantity = item.getProdQuantity();
                    ...
                    <tr> 
                        ...
                        <td>
                            <form method="post" action="./UpdateToCartServlet"> 
                        ...
                        <td>
                            <a 
                                href="./CartDetailsServlet?add=1&uid=<%=userName%>&pid=<%=product.getProdId()%>&avail=<%=product.getProdQuantity()%>&qty=<%=prodQuantity%>">
