    ...
    <body style="background-color: #E6F9E6;">
        ...
        <%
            ...
            if (userName == null || password == null) {
                response.sendRedirect("login.jsp?message=Access Denied ! Please login For Purchase");
            }
                ...
                <form action="./OrderServlet" method="post"
                    ...
                    <div class="text-center mt-3">
                        <div class="form-group">
                            <img src="Image/payment.png" alt="Payment Proceed" height="100px" />
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6 form-group"> 
                            ...
                            <input type="number"  placeholder="YYYY" class="form-control" 
                                   size="4" id="last_name"  min="<%=currYear%>" name="expyear" required>
                        </div>
                    </div>
                    <div class="row mt-3 mb-3">
                        <div class="col-md-6 form-group">
                            <label for="last_name">Enter CVV</label>
                            <input type="number" placeholder="123" class="form-control" size="3" id="last_name"
