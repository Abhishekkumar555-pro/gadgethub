...
<%@page import="in.gadgethub.dao.*,in.gadgethub.ulility.*,in.gadgethub.pojo.*,in.gadgethub.dao.impl.*" %>
...
//                                    String prodName = order.getProdName().substring(0, Math.min(0, 20));
                        ...
                        <tr>
                            ...
                            <td>
                                <%=order.getProdName().substring(0,Math.min(20,order.getProdName().length())) %>     
                            </td>
